=============================
Account Invoice Custom Report
=============================

.. !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! This module adds the aggrement field and also    !!
...
This module adds the aggrement field and also adds them to the report.

Install
=======


* Go to applications > Find module "account_invoice_custom_report" > Press Install
