=================================
Inter Company Invoices - Currency
=================================

.. !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! This module modifies the creation of invoices       !!
...
This module extends the functionality of the inter company invoices.
...
* Find module "account_invoice_inter_company_currency"

* Press Install

* Go to Accounting > Customer > Invoices > and see the modifications
