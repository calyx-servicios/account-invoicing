================================
Earnings Withholding Calculation
================================
...
This module performs the calculation of earnings withholdings.
...
* Find module "earnings_withholding_calculation" > Press Install

* Go to Accounting > Supplier > Payments > and see the modifications
