===================================
Invoice Refund Retain Currency Rate
===================================
...
This module extends the functionality of Account to support Credit Notes with same currency rate of invoices.
...
1. At the time we create a Refund (Credit Note), it should use the currency rate of the invoice instead of the current currency rate.
