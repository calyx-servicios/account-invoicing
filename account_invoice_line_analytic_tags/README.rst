====================================
Account Invoice Lines Analytic Tags
====================================
...
This module extends the functionality of account invoice and allows choose one analytic account and load the analytic tags by default. 
...
1.- [account_invoice_line_analytic] by Calyx.

Usage
=====

1. Go to account supplier invoice, choose one analytic account.
